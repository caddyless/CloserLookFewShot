...
class MetaTemplate(nn.Module):
    def __init__(self, model_func, n_way, n_support, change_way=True, flatten=True):
        super(MetaTemplate, self).__init__()
        self.flat       = flatten
        self.n_way      = n_way
        self.n_support  = n_support
        self.n_query    = -1 #(change depends on input) 
        self.feature    = model_func(flatten)
    ...
    def parse_feature(self, x, is_feature):
        ...
        if is_feature:
            ...
            if self.flat:
                ...
                z_all       = z_all.view( self.n_way, self.n_support + self.n_query, *z_all.shape[1:])
